...
First, add a basemap to your project. Since the XYZ layers are already set up, follow these steps:

1. In the Browser panel, select **XYZ Tiles**.
2. Double-click the layer you would like to use. It will appear in the Layers panel.

Next, add data from the Victorian dataset that was connected in the previous section.
1. In the top menu bar, click **Layer** > **Add Layer** > **Add WMS/WMTS Layer**.
   ![Where to click to add a layer through the menu bar](../figs/GISI/Working_With_Files/add-wms-layer.png)
2. In the Data Source Manager, select the Victorian dataset and click **Connect**.
3. Search for the type of data you would like. For example, search for "river" and then select the layer you want to add.
4. Click **Add** to load the selected layer into your project. It will appear in the Layers panel.
...
1. In the top menu bar, click **Layer** > **Add Layer** > **Add Vector Layer**.
   ![Where to click to add a layer through the menu bar](../figs/GISI/Working_With_Files/add-vector-layer.png)
...
Think of your map data like two ways to draw a picture. 

Vector data captures individual features (points, lines, polygons) using vertices defined by coordinates, and connects them using straight lines. You can change the symbols ( colours, style, icons) for these kinds of data. We call such data "vector features", and their geometries can be **edited**, incl. changing the attributes of these geometries (such as the type of a site, or the name of a river). Data measured from GPS are imported as points or lines.

Raster data behave like images, and are made of tiny squares (pixels) that cover a whole area and where each pixel has a single value per **band**. Elevation model data also come as rasters. You can change the colour scheme for rasters, but you cannot edit the individual pixels or their values. Rasters are often used for background maps, satellite imagery, or elevation data.
...
**Feedback**
```{=html}
<iframe width="640px" height="480px" src="https://forms.office.com/Pages/ResponsePage.aspx?id=z_NbDvQft0aRdlLFOMIqTcB7gT7amOFBtQpSrGmDhYZUREYyMzAyMzhHUk9WUkFQRDhWTlZDU01INiQlQCN0PWcu&embed=true" frameborder="0" marginwidth="0" marginheight="0" style="border: none; max-width:100%; max-height:100vh" allowfullscreen webkitallowfullscreen mozallowfullscreen msallowfullscreen> </iframe>
```