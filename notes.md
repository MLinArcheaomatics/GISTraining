...
### Basics for navigating QGIS:

- QGIS Interface - what are you navigating
...
### How to produce a print layout:

- What are all the necessary components (BOLTS)? (I can also provide gov. specifications for registrations).
- Overview maps and how to get extent indicators on them.
- Creating inset maps.
- Symbology themes (advanced)
- Customising and changing legend text.
- Creating and using templates.
- Locking layers and styles.
