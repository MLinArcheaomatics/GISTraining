...
Click the Legend button in the toolbar and drag on the canvas to place it. 
...
1. Renaming Items: Double-click an item, or click the Edit button, to change its name.

2. Use the plus (+) or minus (-) buttons to add or remove layers from the legend.
...
Add Text button in the toolbar and click/drag on the canvas to place it.
